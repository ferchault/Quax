...
def perturbative_triples(T1, T2, V, fock_Od, fock_Vd):
    ...
    def inner_func(i, j, k):
        ...
        V = (
            W
            + jnp.einsum("bc,a", Voovv[j, k, :, :], T1[i, :])
        ...
        with loops.Scope() as s:
            ...
            for _ in s.while_range(
                lambda: s.a < v
            ):  # TODO this could be converted to s.range, may improve autodiff performance
                s.b = 0
                for _ in s.while_range(lambda: s.b < s.a + 1):
                    ...
                    for _ in s.while_range(lambda: s.c < s.b + 1):
                        ...
                        X = (
                            W[s.a, s.b, s.c] * V[s.a, s.b, s.c]
                            + W[s.a, s.c, s.b] * V[s.a, s.c, s.b]
                            + W[s.b, s.a, s.c] * V[s.b, s.a, s.c]
                            + W[s.b, s.c, s.a] * V[s.b, s.c, s.a]
                            + W[s.c, s.a, s.b] * V[s.c, s.a, s.b]
                            + W[s.c, s.b, s.a] * V[s.c, s.b, s.a]
                        )
                        Y = V[s.a, s.b, s.c] + V[s.b, s.c, s.a] + V[s.c, s.a, s.b]
                        Z = V[s.a, s.c, s.b] + V[s.b, s.a, s.c] + V[s.c, s.b, s.a]
                        E = (
                            (Y - 2 * Z)
                            * (W[s.a, s.b, s.c] + W[s.b, s.c, s.a] + W[s.c, s.a, s.b])
                            + (Z - 2 * Y)
                            * (W[s.a, s.c, s.b] + W[s.b, s.a, s.c] + W[s.c, s.b, s.a])
                            + 3 * X
                        )
...
def rccsd_t(
    geom, basis_name, xyz_path, nuclear_charges, charge, options, deriv_order=0
):
    E_ccsd, T1, T2, V, fock_Od, fock_Vd = rccsd(
        geom,
        basis_name,
        xyz_path,
        nuclear_charges,
